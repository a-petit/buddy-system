...
scmd acmd[] = {
  [CMD_HELP] = {
    .label = 'h',
    .comment = "affiche cette aide",
    .nparam = 0,
    .action.v = pgm_help,
  },
  [CMD_STATUS] = {
    .label = 's',
    .comment = "affiche le statut des variables programme",
    .nparam = 0,
    .action.v = pgm_status,
  },
  [CMD_QUIT] = {
    .label = 'q',
    .comment = "quitte la simulation",
    .nparam = 0,
    .action.v = pgm_quit,
  },
  [CMD_ALLOC] = {
    .label = 'm',
    .comment = "suivi d'une valeur entière positive n, affecte à %s l'adresse\n"
  ...
  [CMD_FREE] = {
    .label = 'f',
    .comment = "libère la variable dynamique reperée par %s",
    .nparam = 1,
    .action.r = pgm_free,
  }
};
...
void pgm_quit(void) {
  m_dispose();
  printf("\nLa pluie peut tomber indéfiniment.\n");
  exit(EXIT_SUCCESS);
}
